```shell
CONFIG GET CONFIG_SETTING_NAME    #获取具体配置信息	
CONFIG GET *    #获取全部配置信息
```
...
增加`requirepass ${password}` 的参数配置

#### 登陆方式

`-a` 指定对应的密码；

`auth myPassword` 验证密码；
...
https://www.cnblogs.com/javastack/p/12848446.html#:~:text=%E6%B2%A1%E9%94%99%EF%BC%8C%E5%A4%A7%E5%AE%B6%E6%89%80%E7%86%9F%E7%9F%A5,%E4%B8%BA%E6%96%87%E4%BB%B6%E4%BA%8B%E4%BB%B6%E5%A4%84%E7%90%86%E5%99%A8%E3%80%82



### Redis 删除复数key

del命令不支持正则匹配删除，可以通过以下方式进行删除
...
redis会通过使用`Gnu调试器`来保证redis崩溃时进行记录，生成core文件



等待详细查看：

https://www.geek-book.com/src/docs/redis/redis/redis.io/topics/debugging.html

https://developer.aliyun.com/article/73676